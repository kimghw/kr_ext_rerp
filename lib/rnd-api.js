...
(function (g) {
  ...
  async function collect(settings) {
    ...
    out.projects = settings.hideZeroProjects ? projects.filter((p) => p.count > 0 || p.error) : projects;
  ...
  g.KRX_API = { call, collect, diagnose, fetchProjects, fetchCards, fetchIssuedCards, fetchAccounts, fetchParticipants, fetchUnapproved, describe };
})(self);
