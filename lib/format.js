...
(function (g) {
  ...
  /* 청구 준비(lib/prep.js · lib/prep-store.js) 키: "승인번호|카드 뒤 4자리". 승인번호가 없는 거래는 빈 문자열(준비 불가) */
  F.prepKey = (apprNo, cardNo) => { const a = String(apprNo == null ? '' : apprNo).trim(); return a ? `${a}|${F.digits(cardNo).slice(-4)}` : ''; };
